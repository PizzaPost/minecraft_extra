...
public class MinecraftExtra implements ModInitializer {
    ...
    private static final Set<Item> TARGET_ITEMS = Set.of(Items.COBBLESTONE, Items.COBBLED_DEEPSLATE, Items.NETHERRACK, Items.DIRT, Items.END_STONE, Items.SAND, Items.STONE, Items.DEEPSLATE);
        ...
        PlayerBlockBreakEvents.BEFORE.register((world, player, pos, state, blockEntity) -> {
            ...
            if (itemStack.isOf(ModItems.HARDENED_NETHERITE_AXE)) {
                if (itemStack.hasEnchantments())
                    HardenedNetheriteAxeItem.postMine(itemStack, world, state, pos, player, Hand.MAIN_HAND);
    ...
    private void checkPlayerHandForEffect(ServerPlayerEntity player, World world) {
        boolean hasHasteGem = player.getStackInHand(Hand.MAIN_HAND).isOf(ModItems.EFFECT_GEM_HASTE) || player.getStackInHand(Hand.OFF_HAND).isOf(ModItems.EFFECT_GEM_HASTE);

        boolean hasWaterBreathingGem = player.getStackInHand(Hand.MAIN_HAND).isOf(ModItems.EFFECT_GEM_WATER_BREATHING) || player.getStackInHand(Hand.OFF_HAND).isOf(ModItems.EFFECT_GEM_WATER_BREATHING);

        boolean hasSlowFallingGem = player.getStackInHand(Hand.MAIN_HAND).isOf(ModItems.EFFECT_GEM_SLOW_FALLING) || player.getStackInHand(Hand.OFF_HAND).isOf(ModItems.EFFECT_GEM_SLOW_FALLING);

        boolean hasStrengthGem = player.getStackInHand(Hand.MAIN_HAND).isOf(ModItems.EFFECT_GEM_STRENGTH) || player.getStackInHand(Hand.OFF_HAND).isOf(ModItems.EFFECT_GEM_STRENGTH);

        boolean hasFireResistanceGem = player.getStackInHand(Hand.MAIN_HAND).isOf(ModItems.EFFECT_GEM_FIRE_RESISTANCE) || player.getStackInHand(Hand.OFF_HAND).isOf(ModItems.EFFECT_GEM_FIRE_RESISTANCE);

        boolean hasJumpBoostGem = player.getStackInHand(Hand.MAIN_HAND).isOf(ModItems.EFFECT_GEM_JUMP_BOOST) || player.getStackInHand(Hand.OFF_HAND).isOf(ModItems.EFFECT_GEM_JUMP_BOOST);

        boolean hasSpeedGem = player.getStackInHand(Hand.MAIN_HAND).isOf(ModItems.EFFECT_GEM_SPEED) || player.getStackInHand(Hand.OFF_HAND).isOf(ModItems.EFFECT_GEM_SPEED);

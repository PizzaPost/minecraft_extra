    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup wrapperLookup, RecipeExporter recipeExporter) {
        return new RecipeGenerator(wrapperLookup, recipeExporter) {
            ...
            public void generate() {
                createShaped(RecipeCategory.MISC, ModItems.ATTRIBUTE_CORE)
                ...
                createShapeless(RecipeCategory.MISC, ModItems.ATTRIBUTE_CORE_EXTRA_HEARTS)
                        .group("minecraft_extra:attribute_core")
                ...
                createShapeless(RecipeCategory.MISC, ModItems.ATTRIBUTE_CORE_GRAVITY)
                        .group("minecraft_extra:attribute_core")
                        .input(ModItems.ATTRIBUTE_CORE)
                        .input(Items.FEATHER)
                        .criterion(hasItem(ModItems.ATTRIBUTE_CORE), conditionsFromItem(ModItems.ATTRIBUTE_CORE))
                ...
                createShaped(RecipeCategory.MISC, ModItems.ATTRIBUTE_CORE_SCALED)
                        .group("minecraft_extra:attribute_core")
                        .pattern("gwg")
                        .pattern("gag")
                        .pattern("gwg")
                ...
                createShapeless(RecipeCategory.MISC, ModItems.ATTRIBUTE_CORE_SPICY)
                        .group("minecraft_extra:attribute_core")
                        .input(ModItems.ATTRIBUTE_CORE)
                ...
                createShapeless(RecipeCategory.MISC, ModItems.ATTRIBUTE_CORE_SPIKES)
                        .group("minecraft_extra:attribute_core")
                        .input(ModItems.ATTRIBUTE_CORE)
                        .input(Items.CACTUS)
                        .criterion(hasItem(ModItems.ATTRIBUTE_CORE), conditionsFromItem(ModItems.ATTRIBUTE_CORE))
                ...
                createShapeless(RecipeCategory.MISC, ModItems.LOOTBOX)
                        .input(Items.DIAMOND)
                        .criterion(hasItem(Items.DIAMOND), conditionsFromItem(Items.DIAMOND))
                        .offerTo(exporter);

                createShapeless(RecipeCategory.MISC, ModItems.GILDED_ILLUSIONER_ESSENCE)
                ...
                createShapeless(RecipeCategory.MISC, ModItems.HARDENED_NETHERITE_INGOT)
                ...
                createShaped(RecipeCategory.COMBAT, ModItems.HARDENED_NETHERITE_HELMET)
                        .pattern("hhh")
                        .pattern("h h")
                ...
                createShaped(RecipeCategory.COMBAT, ModItems.HARDENED_NETHERITE_CHESTPLATE)
                        .pattern("h h")
                        .pattern("hhh")
                        .pattern("hhh")
                        .input('h', ModItems.HARDENED_NETHERITE_INGOT)
                ...
                createShaped(RecipeCategory.COMBAT, ModItems.HARDENED_NETHERITE_LEGGINGS)
                        .pattern("hhh")
                        .pattern("h h")
                        .pattern("h h")
                        .input('h', ModItems.HARDENED_NETHERITE_INGOT)
                ...
                createShaped(RecipeCategory.COMBAT, ModItems.HARDENED_NETHERITE_BOOTS)
                        .pattern("h h")
                        .pattern("h h")
                        .input('h', ModItems.HARDENED_NETHERITE_INGOT)
                        .criterion(hasItem(ModItems.HARDENED_NETHERITE_INGOT), conditionsFromItem(ModItems.HARDENED_NETHERITE_INGOT))
                ...
                createShaped(RecipeCategory.TOOLS, ModItems.HARDENED_NETHERITE_PICKAXE)
                        .pattern("hhh")
                        .pattern(" s ")
                        .pattern(" s ")
                        .input('h', ModItems.HARDENED_NETHERITE_INGOT)
                ...
                createShaped(RecipeCategory.TOOLS, ModItems.HARDENED_NETHERITE_AXE)
                        ...
                        .criterion(hasItem(ModItems.HARDENED_NETHERITE_INGOT), conditionsFromItem(ModItems.HARDENED_NETHERITE_INGOT))
                        .criterion(hasItem(Items.STICK), conditionsFromItem(Items.STICK))
                        .offerTo(exporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(MinecraftExtra.MOD_ID, "hardened_netherite_axe_left")));
                ...
                createShaped(RecipeCategory.TOOLS, ModItems.HARDENED_NETHERITE_AXE)
                        ...
                        .criterion(hasItem(ModItems.HARDENED_NETHERITE_INGOT), conditionsFromItem(ModItems.HARDENED_NETHERITE_INGOT))
                        .criterion(hasItem(Items.STICK), conditionsFromItem(Items.STICK))
                        .offerTo(exporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(MinecraftExtra.MOD_ID, "hardened_netherite_axe_right")));
                ...
                createShaped(RecipeCategory.TOOLS, ModItems.HARDENED_NETHERITE_HOE)
                        .group("minecraft_extra:hardened_netherite_hoe")
                        .pattern("hh")
                        .pattern(" s")
                        .pattern(" s")
                        .input('h', ModItems.HARDENED_NETHERITE_INGOT)
                        ...
                        .criterion(hasItem(ModItems.HARDENED_NETHERITE_INGOT), conditionsFromItem(ModItems.HARDENED_NETHERITE_INGOT))
                        .criterion(hasItem(Items.STICK), conditionsFromItem(Items.STICK))
                        .offerTo(exporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(MinecraftExtra.MOD_ID, "hardened_netherite_hoe_left")));
                ...
                createShaped(RecipeCategory.TOOLS, ModItems.HARDENED_NETHERITE_HOE)
                        ...
                        .criterion(hasItem(ModItems.HARDENED_NETHERITE_INGOT), conditionsFromItem(ModItems.HARDENED_NETHERITE_INGOT))
                        .criterion(hasItem(Items.STICK), conditionsFromItem(Items.STICK))
                        .offerTo(exporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(MinecraftExtra.MOD_ID, "hardened_netherite_hoe_right")));

                createShaped(RecipeCategory.MISC, ModItems.FLUTE)
                ...
                createShapeless(RecipeCategory.MISC, ModItems.GRAVITY_SHARD)
                ...
                createShaped(RecipeCategory.COMBAT, ModItems.TP_STICK)
                ...
                createShapeless(RecipeCategory.MISC, ModItems.ICEBOMB, 10)
                ...
                createShapeless(RecipeCategory.MISC, ModItems.THROWABLE_FIRECHARGE)
                        .input(Items.FIRE_CHARGE)
                        .criterion(hasItem(Items.FIRE_CHARGE), conditionsFromItem(Items.FIRE_CHARGE))
                        .offerTo(exporter);

                createShapeless(RecipeCategory.MISC, ModItems.STRONG_THROWABLE_FIRECHARGE)
                ...
                createShapeless(RecipeCategory.MISC, ModItems.SUPER_STRONG_THROWABLE_FIRECHARGE)
                        ...
                        .criterion(hasItem(Items.GUNPOWDER), conditionsFromItem(Items.GUNPOWDER))
                        .offerTo(exporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(MinecraftExtra.MOD_ID, "super_strong_throwable_firecharge_from_strong_throwable_firecharge")));
                ...
                createShapeless(RecipeCategory.MISC, ModItems.SUPER_STRONG_THROWABLE_FIRECHARGE)
                        ...
                        .criterion(hasItem(ModItems.THROWABLE_FIRECHARGE), conditionsFromItem(ModItems.THROWABLE_FIRECHARGE))
                        .criterion(hasItem(Items.GUNPOWDER), conditionsFromItem(Items.GUNPOWDER))
                        .offerTo(exporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(MinecraftExtra.MOD_ID, "super_strong_throwable_firecharge_from_throwable_firecharge")));

                createShapeless(RecipeCategory.MISC, Items.FIRE_CHARGE)
                        .input(ModItems.THROWABLE_FIRECHARGE)
                        .criterion(hasItem(ModItems.THROWABLE_FIRECHARGE), conditionsFromItem(ModItems.THROWABLE_FIRECHARGE))
                        .offerTo(exporter);

                createShaped(RecipeCategory.FOOD, ModItems.SUPER_FERTILIZER)
                        .pattern("rrr")
                        .pattern("rwr")
                        .pattern("rrr")
                ...
                createShaped(RecipeCategory.COMBAT, ModItems.EFFECT_GEM)
                ...
                createShapeless(RecipeCategory.COMBAT, ModItems.EFFECT_GEM_SLOW_FALLING)
                        .group("minecraft_extra:effect_gems")
                ...
                createShapeless(RecipeCategory.COMBAT, ModItems.EFFECT_GEM_FIRE_RESISTANCE)
                        .group("minecraft_extra:effect_gems")
                        .input(ModItems.EFFECT_GEM)
                ...
                createShaped(RecipeCategory.COMBAT, ModItems.EFFECT_GEM_PUSH)
                        .group("minecraft_extra:effect_gems")
                        .pattern("www")
                        .pattern("wew")
                        .pattern("www")
                ...
                createShaped(RecipeCategory.TOOLS, ModItems.HAMMER)
                        .pattern("i")
                        .pattern("s")
                        .input('i', Items.IRON_INGOT)
                        .input('s', Items.STICK)
                ...
                createShaped(RecipeCategory.MISC, ModItems.ROTTEN_CHUNK)
                        .pattern("rrr")
                        .pattern("rrr")
                        .pattern("rrr")
                        .input('r', Items.ROTTEN_FLESH)
                ...
                StonecuttingRecipeJsonBuilder.createStonecutting(Ingredient.ofItems(ModBlocks.FLINT_BLOCK), RecipeCategory.MISC, ModBlocks.FLINT_BRICKS)
                        .criterion(hasItem(ModBlocks.FLINT_BLOCK), conditionsFromItem(ModBlocks.FLINT_BLOCK))
                        .offerTo(exporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(MinecraftExtra.MOD_ID, "stonecutting/flint_brick")));

                createShaped(RecipeCategory.MISC, ModBlocks.FLINT_SLAB, 6)
                        .pattern("fff")
                        .input('f', ModBlocks.FLINT_BLOCK)
                        .criterion(hasItem(ModBlocks.FLINT_BLOCK), conditionsFromItem(ModBlocks.FLINT_BLOCK))
                        .offerTo(exporter);

                StonecuttingRecipeJsonBuilder.createStonecutting(Ingredient.ofItems(ModBlocks.FLINT_BLOCK), RecipeCategory.MISC, ModBlocks.FLINT_SLAB, 2)
                        .criterion(hasItem(ModBlocks.FLINT_BLOCK), conditionsFromItem(ModBlocks.FLINT_BLOCK))
                        .offerTo(exporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(MinecraftExtra.MOD_ID, "stonecutting/flint_slab")));

                createShaped(RecipeCategory.MISC, ModBlocks.FLINT_STAIR, 4)
                        .pattern("f  ")
                        .pattern("ff ")
                        .pattern("fff")
                        .input('f', ModBlocks.FLINT_BLOCK)
                ...
                StonecuttingRecipeJsonBuilder.createStonecutting(Ingredient.ofItems(ModBlocks.FLINT_BLOCK), RecipeCategory.MISC, ModBlocks.FLINT_STAIR)
                        .criterion(hasItem(ModBlocks.FLINT_BLOCK), conditionsFromItem(ModBlocks.FLINT_BLOCK))
                        .offerTo(exporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(MinecraftExtra.MOD_ID, "stonecutting/flint_stair")));

                createShaped(RecipeCategory.MISC, ModBlocks.FLINT_WALL, 6)
                        .pattern("fff")
                        .pattern("fff")
                        .input('f', ModBlocks.FLINT_BLOCK)
                        .criterion(hasItem(ModBlocks.FLINT_BLOCK), conditionsFromItem(ModBlocks.FLINT_BLOCK))
                ...
                StonecuttingRecipeJsonBuilder.createStonecutting(Ingredient.ofItems(ModBlocks.FLINT_BLOCK), RecipeCategory.MISC, ModBlocks.FLINT_WALL)
                        .criterion(hasItem(ModBlocks.FLINT_BLOCK), conditionsFromItem(ModBlocks.FLINT_BLOCK))
                        .offerTo(exporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(MinecraftExtra.MOD_ID, "stonecutting/flint_wall")));

                createShaped(RecipeCategory.MISC, ModBlocks.CHISELED_FLINT_BRICKS)
                        .pattern("f")
                        .pattern("f")
                ...
                createShaped(RecipeCategory.MISC, ModBlocks.FLINT_BRICK_SLAB, 6)
                        .pattern("fff")
                ...
                StonecuttingRecipeJsonBuilder.createStonecutting(Ingredient.ofItems(ModBlocks.FLINT_BRICKS), RecipeCategory.MISC, ModBlocks.FLINT_BRICK_SLAB, 2)
                        .criterion(hasItem(ModBlocks.FLINT_BRICKS), conditionsFromItem(ModBlocks.FLINT_BRICKS))
                        .offerTo(exporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(MinecraftExtra.MOD_ID, "stonecutting/flint_brick_slab")));

                createShaped(RecipeCategory.MISC, ModBlocks.FLINT_BRICK_STAIR, 4)
                        .pattern("f  ")
                        .pattern("ff ")
                        .pattern("fff")
                        .input('f', ModBlocks.FLINT_BRICKS)
                ...
                StonecuttingRecipeJsonBuilder.createStonecutting(Ingredient.ofItems(ModBlocks.FLINT_BRICKS), RecipeCategory.MISC, ModBlocks.FLINT_BRICK_STAIR)
                        .criterion(hasItem(ModBlocks.FLINT_BRICKS), conditionsFromItem(ModBlocks.FLINT_BRICKS))
                        .offerTo(exporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(MinecraftExtra.MOD_ID, "stonecutting/flint_brick_stair")));

                createShaped(RecipeCategory.MISC, ModBlocks.FLINT_BRICK_WALL, 6)
                        .pattern("fff")
                        .pattern("fff")
                        .input('f', ModBlocks.FLINT_BRICKS)
                        .criterion(hasItem(ModBlocks.FLINT_BRICKS), conditionsFromItem(ModBlocks.FLINT_BRICKS))
                ...
                StonecuttingRecipeJsonBuilder.createStonecutting(Ingredient.ofItems(ModBlocks.FLINT_BRICKS), RecipeCategory.MISC, ModBlocks.FLINT_BRICK_WALL)
                        .criterion(hasItem(ModBlocks.FLINT_BRICKS), conditionsFromItem(ModBlocks.FLINT_BRICKS))
                        .offerTo(exporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(MinecraftExtra.MOD_ID, "stonecutting/flint_brick_wall")));

                createShapeless(RecipeCategory.TOOLS, ModItems.BIG_FLINT_AND_STEEL)
                        .input(ModBlocks.FLINT_BLOCK)
                ...
                createShaped(RecipeCategory.MISC, ModBlocks.FEATHER_BLOCK)
                        .pattern("fff")
                        .pattern("fff")
                        .pattern("fff")
                ...
                createShapeless(RecipeCategory.TOOLS, ModItems.BIOME_COMPASS)
                        .input(Items.COMPASS)
                ...
                createShaped(RecipeCategory.FOOD, ModItems.FAT)
                        .pattern("ss")
                        .pattern("ss")
                ...
                createShapeless(RecipeCategory.MISC, ModItems.SOAP)
                        .input(ModItems.FAT)
                        .input(ModItems.ASH)
                ...
                createShaped(RecipeCategory.COMBAT, ModItems.TIME_CONTROL_DEVICE)
                        .pattern(" d ")
                        .pattern("iti")
                        .pattern("iii")

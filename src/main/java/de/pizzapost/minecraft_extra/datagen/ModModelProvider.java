...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        BlockStateModelGenerator.BlockTexturePool whiteConcreteBlockPool = blockStateModelGenerator.registerCubeAllModelTexturePool(Blocks.WHITE_CONCRETE);
        BlockStateModelGenerator.BlockTexturePool lightGrayConcreteBlockPool = blockStateModelGenerator.registerCubeAllModelTexturePool(Blocks.LIGHT_GRAY_CONCRETE);
        BlockStateModelGenerator.BlockTexturePool grayConcreteBlockPool = blockStateModelGenerator.registerCubeAllModelTexturePool(Blocks.GRAY_CONCRETE);
        BlockStateModelGenerator.BlockTexturePool blackConcreteBlockPool = blockStateModelGenerator.registerCubeAllModelTexturePool(Blocks.BLACK_CONCRETE);
        BlockStateModelGenerator.BlockTexturePool brownConcreteBlockPool = blockStateModelGenerator.registerCubeAllModelTexturePool(Blocks.BROWN_CONCRETE);
        BlockStateModelGenerator.BlockTexturePool redConcreteBlockPool = blockStateModelGenerator.registerCubeAllModelTexturePool(Blocks.RED_CONCRETE);
        BlockStateModelGenerator.BlockTexturePool orangeConcreteBlockPool = blockStateModelGenerator.registerCubeAllModelTexturePool(Blocks.ORANGE_CONCRETE);
        BlockStateModelGenerator.BlockTexturePool yellowConcreteBlockPool = blockStateModelGenerator.registerCubeAllModelTexturePool(Blocks.YELLOW_CONCRETE);
        BlockStateModelGenerator.BlockTexturePool limeConcreteBlockPool = blockStateModelGenerator.registerCubeAllModelTexturePool(Blocks.LIME_CONCRETE);
        BlockStateModelGenerator.BlockTexturePool greenConcreteBlockPool = blockStateModelGenerator.registerCubeAllModelTexturePool(Blocks.GREEN_CONCRETE);
        BlockStateModelGenerator.BlockTexturePool cyanConcreteBlockPool = blockStateModelGenerator.registerCubeAllModelTexturePool(Blocks.CYAN_CONCRETE);
        BlockStateModelGenerator.BlockTexturePool lightBlueConcreteBlockPool = blockStateModelGenerator.registerCubeAllModelTexturePool(Blocks.LIGHT_BLUE_CONCRETE);
        BlockStateModelGenerator.BlockTexturePool blueConcreteBlockPool = blockStateModelGenerator.registerCubeAllModelTexturePool(Blocks.BLUE_CONCRETE);
        BlockStateModelGenerator.BlockTexturePool purpleConcreteBlockPool = blockStateModelGenerator.registerCubeAllModelTexturePool(Blocks.PURPLE_CONCRETE);
        BlockStateModelGenerator.BlockTexturePool magentaConcreteBlockPool = blockStateModelGenerator.registerCubeAllModelTexturePool(Blocks.MAGENTA_CONCRETE);
        BlockStateModelGenerator.BlockTexturePool pinkConcreteBlockPool = blockStateModelGenerator.registerCubeAllModelTexturePool(Blocks.PINK_CONCRETE);
        ...
        whiteConcreteBlockPool.slab(ModBlocks.WHITE_CONCRETE_SLAB);
        whiteConcreteBlockPool.stairs(ModBlocks.WHITE_CONCRETE_STAIR);
        whiteConcreteBlockPool.wall(ModBlocks.WHITE_CONCRETE_WALL);
        lightGrayConcreteBlockPool.slab(ModBlocks.LIGHT_GRAY_CONCRETE_SLAB);
        lightGrayConcreteBlockPool.stairs(ModBlocks.LIGHT_GRAY_CONCRETE_STAIR);
        lightGrayConcreteBlockPool.wall(ModBlocks.LIGHT_GRAY_CONCRETE_WALL);
        grayConcreteBlockPool.slab(ModBlocks.GRAY_CONCRETE_SLAB);
        grayConcreteBlockPool.stairs(ModBlocks.GRAY_CONCRETE_STAIR);
        grayConcreteBlockPool.wall(ModBlocks.GRAY_CONCRETE_WALL);
        blackConcreteBlockPool.slab(ModBlocks.BLACK_CONCRETE_SLAB);
        blackConcreteBlockPool.stairs(ModBlocks.BLACK_CONCRETE_STAIR);
        blackConcreteBlockPool.wall(ModBlocks.BLACK_CONCRETE_WALL);
        brownConcreteBlockPool.slab(ModBlocks.BROWN_CONCRETE_SLAB);
        brownConcreteBlockPool.stairs(ModBlocks.BROWN_CONCRETE_STAIR);
        brownConcreteBlockPool.wall(ModBlocks.BROWN_CONCRETE_WALL);
        redConcreteBlockPool.slab(ModBlocks.RED_CONCRETE_SLAB);
        redConcreteBlockPool.stairs(ModBlocks.RED_CONCRETE_STAIR);
        redConcreteBlockPool.wall(ModBlocks.RED_CONCRETE_WALL);
        orangeConcreteBlockPool.slab(ModBlocks.ORANGE_CONCRETE_SLAB);
        orangeConcreteBlockPool.stairs(ModBlocks.ORANGE_CONCRETE_STAIR);
        orangeConcreteBlockPool.wall(ModBlocks.ORANGE_CONCRETE_WALL);
        yellowConcreteBlockPool.slab(ModBlocks.YELLOW_CONCRETE_SLAB);
        yellowConcreteBlockPool.stairs(ModBlocks.YELLOW_CONCRETE_STAIR);
        yellowConcreteBlockPool.wall(ModBlocks.YELLOW_CONCRETE_WALL);
        limeConcreteBlockPool.slab(ModBlocks.LIME_CONCRETE_SLAB);
        limeConcreteBlockPool.stairs(ModBlocks.LIME_CONCRETE_STAIR);
        limeConcreteBlockPool.wall(ModBlocks.LIME_CONCRETE_WALL);
        greenConcreteBlockPool.slab(ModBlocks.GREEN_CONCRETE_SLAB);
        greenConcreteBlockPool.stairs(ModBlocks.GREEN_CONCRETE_STAIR);
        greenConcreteBlockPool.wall(ModBlocks.GREEN_CONCRETE_WALL);
        cyanConcreteBlockPool.slab(ModBlocks.CYAN_CONCRETE_SLAB);
        cyanConcreteBlockPool.stairs(ModBlocks.CYAN_CONCRETE_STAIR);
        cyanConcreteBlockPool.wall(ModBlocks.CYAN_CONCRETE_WALL);
        lightBlueConcreteBlockPool.slab(ModBlocks.LIGHT_BLUE_CONCRETE_SLAB);
        lightBlueConcreteBlockPool.stairs(ModBlocks.LIGHT_BLUE_CONCRETE_STAIR);
        lightBlueConcreteBlockPool.wall(ModBlocks.LIGHT_BLUE_CONCRETE_WALL);
        blueConcreteBlockPool.slab(ModBlocks.BLUE_CONCRETE_SLAB);
        blueConcreteBlockPool.stairs(ModBlocks.BLUE_CONCRETE_STAIR);
        blueConcreteBlockPool.wall(ModBlocks.BLUE_CONCRETE_WALL);
        purpleConcreteBlockPool.slab(ModBlocks.PURPLE_CONCRETE_SLAB);
        purpleConcreteBlockPool.stairs(ModBlocks.PURPLE_CONCRETE_STAIR);
        purpleConcreteBlockPool.wall(ModBlocks.PURPLE_CONCRETE_WALL);
        magentaConcreteBlockPool.slab(ModBlocks.MAGENTA_CONCRETE_SLAB);
        magentaConcreteBlockPool.stairs(ModBlocks.MAGENTA_CONCRETE_STAIR);
        magentaConcreteBlockPool.wall(ModBlocks.MAGENTA_CONCRETE_WALL);
        pinkConcreteBlockPool.slab(ModBlocks.PINK_CONCRETE_SLAB);
        pinkConcreteBlockPool.stairs(ModBlocks.PINK_CONCRETE_STAIR);
        pinkConcreteBlockPool.wall(ModBlocks.PINK_CONCRETE_WALL);
    }

...
public class HardenedNetheriteAxeItem extends AxeItem {
    ...
    public HardenedNetheriteAxeItem(ToolMaterial material, Settings settings) {
    ...
    private static void breakTree(ServerWorld world, BlockPos start, PlayerEntity miner, ItemStack tool, Hand hand) {
        ...
        stack.push(start);
        BlockPos[] neighbors = {
                new BlockPos(1, 0, 0), new BlockPos(-1, 0, 0), new BlockPos(0, 1, 0), new BlockPos(0, -1, 0),
                new BlockPos(0, 0, 1), new BlockPos(0, 0, -1), // Direkt angrenzend

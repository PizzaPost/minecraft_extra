            ...
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.HARDENED_NETHERITE_ARMOR_MATERIAL,
                            List.of(new StatusEffectInstance(StatusEffects.HASTE, 10, 2, false, false),
                                    new StatusEffectInstance(StatusEffects.REGENERATION, 10, 1, false, false),
                                    ...
                                    new StatusEffectInstance(StatusEffects.SATURATION, 10, 1, false, false),
                                    new StatusEffectInstance(ModEffects.SPIDER, 10, 1, false, false))).build();

...
public class AttributeCoreExtraHeartsItem extends Item {
    ...
    public ActionResult use(World world, PlayerEntity player, Hand hand) {
        try {
            ...
            player.getAttributeInstance(EntityAttributes.MAX_HEALTH).addTemporaryModifier(new EntityAttributeModifier(Identifier.of(MinecraftExtra.MOD_ID, "attribute_core_extra_hearts"), 20, EntityAttributeModifier.Operation.ADD_VALUE));

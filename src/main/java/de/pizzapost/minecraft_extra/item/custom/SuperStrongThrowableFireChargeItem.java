...
public class SuperStrongThrowableFireChargeItem extends Item {

    public SuperStrongThrowableFireChargeItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult use(World world, PlayerEntity player, Hand hand) {
        ...
        if (!world.isClient()) {
            ...
            FireballEntity fireball = new FireballEntity(world, player, Vec, 13);

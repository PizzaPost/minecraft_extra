...
public class ModArmorMaterials {
    public static EquipmentModel HARDENED_NETHERITE_INGOT = EquipmentModel.builder().addHumanoidLayers(Identifier.of(MinecraftExtra.MOD_ID, "hardened_netherite")).build();
    ...
    }), 20, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 0, 0, ModTags.Items.HARDENED_NETHERITE_REPAIR, Identifier.of(MinecraftExtra.MOD_ID, "hardened_netherite"));
}

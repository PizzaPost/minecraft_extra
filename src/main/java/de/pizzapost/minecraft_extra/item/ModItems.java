...
public class ModItems {
    ...
    public static final Item HARDENED_NETHERITE_HELMET = registerItem("hardened_netherite_helmet", settings -> new ModArmorItem(ModArmorMaterials.HARDENED_NETHERITE_ARMOR_MATERIAL, EquipmentType.HELMET, settings.fireproof().maxCount(1).rarity(Rarity.EPIC)) {
        @Override
        public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
    ...
    public static final Item HARDENED_NETHERITE_CHESTPLATE = registerItem("hardened_netherite_chestplate", settings -> new ArmorItem(ModArmorMaterials.HARDENED_NETHERITE_ARMOR_MATERIAL, EquipmentType.CHESTPLATE, settings.fireproof().maxCount(1).rarity(Rarity.EPIC)) {
        @Override
        public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
            tooltip.add(Text.translatable("tooltip.minecraft_extra.right_click_hardened_netherite_armor"));
            tooltip.add(Text.literal(""));
    ...
    public static final Item HARDENED_NETHERITE_LEGGINGS = registerItem("hardened_netherite_leggings", settings -> new ArmorItem(ModArmorMaterials.HARDENED_NETHERITE_ARMOR_MATERIAL, EquipmentType.LEGGINGS, settings.fireproof().maxCount(1).rarity(Rarity.EPIC)) {
        @Override
        public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
            tooltip.add(Text.translatable("tooltip.minecraft_extra.right_click_hardened_netherite_armor"));
            tooltip.add(Text.literal(""));
    ...
    public static final Item HARDENED_NETHERITE_BOOTS = registerItem("hardened_netherite_boots", settings -> new ArmorItem(ModArmorMaterials.HARDENED_NETHERITE_ARMOR_MATERIAL, EquipmentType.BOOTS, settings.fireproof().maxCount(1).rarity(Rarity.EPIC)) {
        @Override
        public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
            tooltip.add(Text.translatable("tooltip.minecraft_extra.right_click_hardened_netherite_armor"));
            tooltip.add(Text.literal(""));
    ...
    public static final Item HAMMER = registerItem("hammer", settings -> new PickaxeItem(ToolMaterial.WOOD, 1.0F, -2.8F, settings.maxCount(1).maxDamage(160)) {
        @Override
        public void appendTooltip(ItemStack stack, Item.TooltipContext context, List<Text> tooltip, TooltipType type) {
    ...
    public static final Item ICEBLAZE_SPAWN_EGG = registerItem("iceblaze_spawn_egg", settings -> new SpawnEggItem(ModEntities.ICEBLAZE, 0x59867d, 0x6dc8b6, settings) {
    });
    ...
    public static final Item END_CRYSTAL_MOB_SPAWN_EGG = registerItem("end_crystal_mob_spawn_egg", settings -> new SpawnEggItem(ModEntities.END_CRYSTAL_MOB, 0xD877FF, 0xF76AD2, settings));
